...
namespace game
{
	...
	//extern float DiffTrackAngle(int a1, int a2, float a3, float a4) {
	//	stdcall_call<void>(0x005DED60, a1, a2, a3, a4);
	//	float result;
	//	__asm
	//	movss result, xmm0
	...
	//extern float __fastcall AngleSubtract(double a1, double a2)
	//{
	//	double v2; // fp1

	//	v2 = (float)((float)((float)((float)((float)a1 - (float)a2) * (float)0.0027777778)
	//		- (float)floor((float)((float)((float)((float)a1 - (float)a2) * (float)0.0027777778) + (float)0.5)))
	//		* (float)360.0);
	//	return *((float*)&v2 + 1);
	//}
}
