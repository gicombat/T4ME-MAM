...
#pragma pack(pop)
		...
		struct centity_s
		{
			...
			unsigned __int32 applyLeftHandIK : 1; //OFS: 0x2D0
		...
		struct Console
		{
			dvar::dvar_s* outputWindowColor; //OFS: 0x0 SIZE: 0x4
		...
		constexpr auto AIM_TARGET_INVALID = 1023;
		...
		struct __declspec(align(4)) AimAssistGlobals
		{
