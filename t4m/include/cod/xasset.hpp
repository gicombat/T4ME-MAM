...
{ 
	namespace engine 
	{
		...
		// ── Post-process / effect Gfx structs (migrated from t4_headers.h 2026-05-11) ──
		...
		struct snd_alias_t
		{
			...
			snd_speaker_map_set* speakerMap; //OFS: 0x80 SIZE: 0x4
			int flags; //OFS: 0x84 SIZE: 0x4
			snd_curve_t* volumeFalloffCurve; //OFS: 0x88 SIZE: 0x4
			snd_curve_t* reverbFalloffCurve; //OFS: 0x8C SIZE: 0x4
			snd_curve_t* volumeMinFalloffCurve; //OFS: 0x90 SIZE: 0x4
			snd_curve_t* reverbMinFalloffCurve; //OFS: 0x94 SIZE: 0x4
			snd_limit_type_t limitType; //OFS: 0x98 SIZE: 0x4
			int limitCount; //OFS: 0x9C SIZE: 0x4
			unsigned int entityLimitCount; //OFS: 0xA0 SIZE: 0x4
			snd_limit_type_t entityLimitType; //OFS: 0xA4 SIZE: 0x4
		...
		ASSERT_STRUCT_OFFSET(snd_alias_t, limitCount, 0x9C);
		ASSERT_STRUCT_OFFSET(snd_alias_t, entityLimitCount, 0xA0);
		ASSERT_STRUCT_OFFSET(snd_alias_t, entityLimitType, 0xA4);
		...
		struct WeaponDef
		{
			...
			// T4M lowReady stance extensions (BO1 port, +0x30 bytes)
			int   iLowReadyInTime;   //OFS: 0x9AC SIZE: 0x4
			int   iLowReadyLoopTime; //OFS: 0x9B0 SIZE: 0x4
			int   iLowReadyOutTime;  //OFS: 0x9B4 SIZE: 0x4
			float lowReadyOfsF;      //OFS: 0x9B8 SIZE: 0x4
			float lowReadyOfsR;      //OFS: 0x9BC SIZE: 0x4
			float lowReadyOfsU;      //OFS: 0x9C0 SIZE: 0x4
			float lowReadyRotP;      //OFS: 0x9C4 SIZE: 0x4
			float lowReadyRotY;      //OFS: 0x9C8 SIZE: 0x4
			float lowReadyRotR;      //OFS: 0x9CC SIZE: 0x4
		...
		union XAssetHeader
		{
			...
			MaterialTechniqueSet* techniqueSet; //OFS: 0x7 SIZE: 0x4
			GfxImage* image; //OFS: 0x8 SIZE: 0x4
			snd_alias_list_t* sound; //OFS: 0x9 SIZE: 0x4
			LoadedSound* loadedSound; //OFS: 0xA SIZE: 0x4
		...
		struct XZoneName
		{
			...
			BYTE dir; //OFS: 0x48 SIZE: 0x1
			bool loaded; //OFS: 0x49 SIZE: 0x1
			BYTE pad[2]; //OFS: 0x4A SIZE: 0x2
		};
		...
		ASSERT_STRUCT_OFFSET(XZoneName, loaded, 0x49);
		...
		ASSERT_STRUCT_SIZE(XZoneQueueEntry, 0x44);
		ASSERT_STRUCT_OFFSET(XZoneQueueEntry, name, 0x0);
		ASSERT_STRUCT_OFFSET(XZoneQueueEntry, allocFlags, 0x40);
		...
		ASSERT_STRUCT_SIZE(ZoneFileEntry, 0x4C);
		ASSERT_STRUCT_OFFSET(ZoneFileEntry, name, 0x00);
		ASSERT_STRUCT_OFFSET(ZoneFileEntry, loadOrder, 0x40);
