...
void Update_cg_fov_user(float* cg_fov_value) {
	T4::dvar::dvar_s* cg_fov_min = *(T4::dvar::dvar_s**)0x0339CBE0;

	T4::dvar::dvar_s* cg_fov = *(T4::dvar::dvar_s**)0x0368EB70;
...
void Update_cg_fovscale_user(float* cg_fovscale_value) {
	T4::dvar::dvar_s* cg_fovscale = *(T4::dvar::dvar_s**)0x03688A04;
...
void CG_DrawMemoryfunc(float* y) {
	...
	if (GlobalMemoryStatusEx(&status)) {
		...
		*y += T4::game::CG_CornerDebugPrint(buffer, x, *y, 0.f, (char*)0x00840FF0, (float*)0x008397F0);
...
inline void Add_User_Fov() {
	...
	cg_fov_user = (T4::dvar::dvar_s*)T4::dvar::Dvar_RegisterFloat("cg_fov_user", 65.f, 1.f, 160.f, DVAR_FLAG_ARCHIVE, (const char*)0x00890514);
	cg_fovscale_user = (T4::dvar::dvar_s*)T4::dvar::Dvar_RegisterFloat("cg_fovscale_user", 1.f, 0.2f, 2.f, DVAR_FLAG_ARCHIVE, (const char*)0x00890540);
