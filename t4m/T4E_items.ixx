...
export namespace T4
{
	namespace engine
	{
		...
		export int __cdecl CG_GetPlayerWeapon(T4::engine::playerState_s* a1, int a2)
		{
		...
		T4::dvar::dvar_s* __cdecl Dvar_RegisterVariant(
			const char* name,
			T4::dvar::dvarType32_t type,
			T4::dvar::DvarFlags32 flags,
			T4::dvar::DvarValue dval,
			T4::dvar::DvarLimits dom,
			const char* desc)
		{
			return cdecl_call<T4::dvar::dvar_s*>(0x5EED90, name, type, flags, dval, dom, desc);
		}
	}
}